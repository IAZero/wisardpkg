...
PYBIND11_MODULE(wisardpkg, m)
{
    ...
    py::class_<Wisard>(m, "Wisard")
      ...
      .def("classify", (py::list (Wisard::*)(const vector<vector<int>>&, py::kwargs)) &Wisard::classify)
    ...
    py::class_<ClusWisard>(m, "ClusWisard")
      ...
      .def("classify", (py::list (ClusWisard::*)(const vector<int>&, py::kwargs kwargs)) &ClusWisard::classify)
      .def("classify", (py::list (ClusWisard::*)(const vector<vector<int>>&, py::kwargs kwargs)) &ClusWisard::classify)
